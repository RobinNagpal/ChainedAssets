      ...
      >
        <div className="flex w-full flex-col items-center space-y-4 sm:items-end">
          ...
          <Transition
            ...
            leaveTo="opacity-0"
          >
            <NotificationPanel className="pointer-events-auto z-50 w-full max-w-sm overflow-hidden rounded-lg shadow-lg ring-1 ring-black ring-opacity-5">
              <div className="p-4">
                <div className="flex items-start">
                  ...
                  <div className="ml-3 w-0 flex-1 pt-0.5">
                    ...
                    <Paragraph className="mt-1 text-sm text-gray-500">
                      {message}
                    </Paragraph>
                  </div>
